...
create_ip -name blk_mem_gen -vendor xilinx.com -library ip -version 8.4 -module_name blk_mem_gen_6
set_property -dict [list CONFIG.Write_Width_A {24} CONFIG.Write_Depth_A {8} CONFIG.Read_Width_A {24} CONFIG.Write_Width_B {24} CONFIG.Read_Width_B {24} CONFIG.Load_Init_File {True} CONFIG.Coe_File {/home/centos/CWM-ECAD/Ex6/mem.coe}] [get_ips blk_mem_gen_6]
read_verilog "top.v"
read_verilog "top_tb.v"
read_verilog "lights.v"
read_verilog "multiplex.v"
read_verilog "Colour_Convert.v"
